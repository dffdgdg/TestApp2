...
internal class SiteEditVM : BaseEditsModel<HistoricalSite>
{
    ...
    public SiteEditVM(HistoricalSite item, INavigationService service)
    {
    ...
    {
        if (db.HistoricalSites.Any(d => d.Id == Item.Id)) db.HistoricalSites.Update(Item);
        else db.HistoricalSites.Add(Item);
